...
#CenterNet
import sys
CENTERNET_PATH = '/home/alanturner/centerNet-deep-sort/CenterNet/src/lib'
...
#MODEL_PATH = '/home/alanturner/centerNet-deep-sort/CenterNet/exp/ctdet/coco_dla/model_best.pth'
ARCH = 'dla_34'

#myvidpath = '/home/alanturner/centerNet-deep-sort/iPatch_trimmed_6b.mp4'
myvidpath = '/home/alanturner/centerNet-deep-sort/iPatch_trimmed_4a.mp4'
...
class Detector(object):
    ...
    def open(self, video_path):
        ...
        if self.write_video:
            ...
            self.output = cv2.VideoWriter("their_model_performance2.avi", fourcc, 30, (self.im_width, self.im_height))
